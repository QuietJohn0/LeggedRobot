/*
 * CAN_2_Legs_stateflow_private.h
 *
...
#ifndef RTW_HEADER_CAN_2_Legs_stateflow_private_h_
#define RTW_HEADER_CAN_2_Legs_stateflow_private_h_
#include "rtwtypes.h"
...
extern void CAN_2_Legs_stateflo_bytesfloats(B_bytesfloats_CAN_2_Legs_stat_T
  *localB);
extern void CAN_2_Legs_stateflo_floatsbytes(real_T rtu_position, real_T
  rtu_velocity, real_T rtu_K_p, real_T rtu_K_d, real_T rtu_T_ff,
  B_floatsbytes_CAN_2_Legs_stat_T *localB);

#endif                          /* RTW_HEADER_CAN_2_Legs_stateflow_private_h_ */
