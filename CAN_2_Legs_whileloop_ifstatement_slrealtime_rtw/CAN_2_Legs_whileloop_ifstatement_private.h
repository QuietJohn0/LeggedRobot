/*
 * CAN_2_Legs_whileloop_ifstatement_private.h
 *
...
#ifndef RTW_HEADER_CAN_2_Legs_whileloop_ifstatement_private_h_
#define RTW_HEADER_CAN_2_Legs_whileloop_ifstatement_private_h_
#include "rtwtypes.h"
...
extern void CAN_2_Legs_whileloo_floatsbytes(real_T rtu_position, real_T
  rtu_velocity, real_T rtu_K_p, real_T rtu_K_d, real_T rtu_T_ff,
  B_floatsbytes_CAN_2_Legs_whil_T *localB);
extern void CAN_2_Legs_whileloop__Subsystem
  (RT_MODEL_CAN_2_Legs_whileloop_ifstatement_T * const
   CAN_2_Legs_whileloop_ifstatement_M, real_T rtu_po, real_T *rtd_po, real_T
   *rtd_to, B_Subsystem_CAN_2_Legs_whilel_T *localB);

#endif              /* RTW_HEADER_CAN_2_Legs_whileloop_ifstatement_private_h_ */
