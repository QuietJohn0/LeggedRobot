#ifndef RTW_HEADER_CAN_2_Legs_whileloop_johnmessingabout_cal_h_
#define RTW_HEADER_CAN_2_Legs_whileloop_johnmessingabout_cal_h_
#include "rtwtypes.h"
#include "CAN_2_Legs_whileloop_johnmessingabout_types.h"

/* Storage class 'PageSwitching', for system '<Root>' */
struct CAN_2_Legs_whileloop_j_cal_type {
  ...
  real_T Curr1_Y0;                     /* Computed Parameter: Curr1_Y0
                                        * Referenced by: '<S7>/Curr1'
                                        */
  real_T ID1_Y0;                       /* Computed Parameter: ID1_Y0
                                        * Referenced by: '<S7>/ID1'
                                        */
  ...
  uint8_T Status1_Y0;                  /* Computed Parameter: Status1_Y0
                                        * Referenced by: '<S7>/Status1'
                                        */
  uint8_T Status2_Y0;                  /* Computed Parameter: Status2_Y0
                                        * Referenced by: '<S7>/Status2'
                                        */
};

/* Storage class 'PageSwitching' */
extern CAN_2_Legs_whileloop_j_cal_type CAN_2_Legs_whileloop_j_cal_impl;
extern CAN_2_Legs_whileloop_j_cal_type *CAN_2_Legs_whileloop_johnme_cal;

#endif             /* RTW_HEADER_CAN_2_Legs_whileloop_johnmessingabout_cal_h_ */
