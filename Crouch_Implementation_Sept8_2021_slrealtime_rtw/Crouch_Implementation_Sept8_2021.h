/*
 * Crouch_Implementation_Sept8_2021.h
 *
...
#ifndef RTW_HEADER_Crouch_Implementation_Sept8_2021_h_
#define RTW_HEADER_Crouch_Implementation_Sept8_2021_h_
#include <stddef.h>
#include <cstring>
#include <cmath>
#include <cstring>
...
#include "Crouch_Implementation_Sept8_2021_types.h"
...
struct B_floatsbytes_Crouch_Implemen_T {
  uint8_T b[8];                        /* '<S4>/floats -> bytes' */
};

/* Block signals (default storage) */
struct B_Crouch_Implementation_Sept8_2021_T {
  ...
  B_floatsbytes_Crouch_Implemen_T sf_floatsbytes_o;/* '<S5>/floats -> bytes' */
  B_floatsbytes_Crouch_Implemen_T sf_floatsbytes;/* '<S4>/floats -> bytes' */
};

/* Block states (default storage) for system '<Root>' */
struct DW_Crouch_Implementation_Sept8_2021_T {
  ...
  uint32_T is_c8_Crouch_Implementation_Sep;/* '<Root>/Chart' */
  uint32_T is_Command;                 /* '<Root>/Chart' */
  uint32_T is_Flight;                  /* '<Root>/Chart' */
  uint32_T is_Stance;                  /* '<Root>/Chart' */
  ...
  uint8_T is_active_c8_Crouch_Implementat;/* '<Root>/Chart' */
  uint8_T temporalCounter_i1;          /* '<Root>/Chart' */
};

/* Real-time Model Data Structure */
struct tag_RTM_Crouch_Implementation_Sept8_2021_T {
...
extern "C" {
  ...
  extern struct B_Crouch_Implementation_Sept8_2021_T
    Crouch_Implementation_Sept8_2021_B;
...
extern struct DW_Crouch_Implementation_Sept8_2021_T
  Crouch_Implementation_Sept8_2021_DW;
...
extern "C" {
  ...
  extern void Crouch_Implementation_Sept8_2021_initialize(void);
  extern void Crouch_Implementation_Sept8_2021_step(void);
  extern void Crouch_Implementation_Sept8_2021_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_Crouch_Implementation_Sept8_2021_T *const
 ...
 *
 * '<Root>' : 'Crouch_Implementation_Sept8_2021'
 * '<S1>'   : 'Crouch_Implementation_Sept8_2021/Chart'
 * '<S2>'   : 'Crouch_Implementation_Sept8_2021/MATLAB Function'
 * '<S3>'   : 'Crouch_Implementation_Sept8_2021/MATLAB Function1'
 * '<S4>'   : 'Crouch_Implementation_Sept8_2021/Simulink Function1'
 * '<S5>'   : 'Crouch_Implementation_Sept8_2021/Simulink Function3'
 * '<S6>'   : 'Crouch_Implementation_Sept8_2021/While Iterator Subsystem'
 * '<S7>'   : 'Crouch_Implementation_Sept8_2021/Simulink Function1/floats -> bytes'
 * '<S8>'   : 'Crouch_Implementation_Sept8_2021/Simulink Function3/floats -> bytes'
 * '<S9>'   : 'Crouch_Implementation_Sept8_2021/While Iterator Subsystem/If Action Subsystem'
 * '<S10>'  : 'Crouch_Implementation_Sept8_2021/While Iterator Subsystem/If Action Subsystem1'
 * '<S11>'  : 'Crouch_Implementation_Sept8_2021/While Iterator Subsystem/If Action Subsystem/bytes -> floats'
 * '<S12>'  : 'Crouch_Implementation_Sept8_2021/While Iterator Subsystem/If Action Subsystem1/bytes -> floats'
 */
#endif                      /* RTW_HEADER_Crouch_Implementation_Sept8_2021_h_ */
