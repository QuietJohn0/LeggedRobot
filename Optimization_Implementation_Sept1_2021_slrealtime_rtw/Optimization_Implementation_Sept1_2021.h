/*
 * Optimization_Implementation_Sept1_2021.h
 *
...
#ifndef RTW_HEADER_Optimization_Implementation_Sept1_2021_h_
#define RTW_HEADER_Optimization_Implementation_Sept1_2021_h_
#include <stddef.h>
#include <cstring>
#include <cmath>
#include <cstring>
...
#include "Optimization_Implementation_Sept1_2021_types.h"
...
struct B_floatsbytes_Optimization_Im_T {
  uint8_T b[8];                        /* '<S4>/floats -> bytes' */
};

/* Block signals (default storage) */
struct B_Optimization_Implementation_Sept1_2021_T {
  ...
  real_T cycles;                       /* '<Root>/Chart' */
  real_T test;                         /* '<Root>/Chart' */
  real_T Score;                        /* '<Root>/Chart' */
  real_T Kguess[4];                    /* '<Root>/Chart' */
  real_T kStep[4];                     /* '<Root>/Chart' */
  real_T pss1;                         /* '<Root>/Chart' */
  real_T tss1;                         /* '<Root>/Chart' */
  real_T OS1;                          /* '<Root>/Chart' */
  real_T OS2;                          /* '<Root>/Chart' */
  real_T tss2;                         /* '<Root>/Chart' */
  real_T pss2;                         /* '<Root>/Chart' */
  ...
  B_floatsbytes_Optimization_Im_T sf_floatsbytes_o;/* '<S5>/floats -> bytes' */
  B_floatsbytes_Optimization_Im_T sf_floatsbytes;/* '<S4>/floats -> bytes' */
};

/* Block states (default storage) for system '<Root>' */
struct DW_Optimization_Implementation_Sept1_2021_T {
  ...
  real_T theta1Release;                /* '<Root>/Chart' */
  real_T theta1Goal;                   /* '<Root>/Chart' */
  real_T theta2Goal;                   /* '<Root>/Chart' */
  real_T theta2Release;                /* '<Root>/Chart' */
  real_T Ksaved[4];                    /* '<Root>/Chart' */
  real_T a1;                           /* '<Root>/Chart' */
  real_T b1;                           /* '<Root>/Chart' */
  real_T c1;                           /* '<Root>/Chart' */
  real_T d1;                           /* '<Root>/Chart' */
  real_T delt1;                        /* '<Root>/Chart' */
  real_T delt2;                        /* '<Root>/Chart' */
  real_T e1;                           /* '<Root>/Chart' */
  real_T oldScore[4];                  /* '<Root>/Chart' */
  real_T oldScoreSlope[4];             /* '<Root>/Chart' */
  real_T temp;                         /* '<Root>/Chart' */
  real_T tr;                           /* '<Root>/Chart' */
  ...
  uint32_T is_c8_Optimization_Implementati;/* '<Root>/Chart' */
  ...
  uint8_T is_active_c8_Optimization_Imple;/* '<Root>/Chart' */
};

/* Real-time Model Data Structure */
struct tag_RTM_Optimization_Implementation_Sept1_2021_T {
...
extern "C" {
  ...
  extern struct B_Optimization_Implementation_Sept1_2021_T
...
extern struct DW_Optimization_Implementation_Sept1_2021_T
...
extern "C" {
  ...
  extern void Optimization_Implementation_Sept1_2021_initialize(void);
  extern void Optimization_Implementation_Sept1_2021_step(void);
  extern void Optimization_Implementation_Sept1_2021_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_Optimization_Implementation_Sept1_2021_T *const
 ...
 *
 * '<Root>' : 'Optimization_Implementation_Sept1_2021'
 * '<S1>'   : 'Optimization_Implementation_Sept1_2021/Chart'
 * '<S2>'   : 'Optimization_Implementation_Sept1_2021/MATLAB Function'
 * '<S3>'   : 'Optimization_Implementation_Sept1_2021/MATLAB Function1'
 * '<S4>'   : 'Optimization_Implementation_Sept1_2021/Simulink Function1'
 * '<S5>'   : 'Optimization_Implementation_Sept1_2021/Simulink Function3'
 * '<S6>'   : 'Optimization_Implementation_Sept1_2021/While Iterator Subsystem'
 * '<S7>'   : 'Optimization_Implementation_Sept1_2021/Simulink Function1/floats -> bytes'
 * '<S8>'   : 'Optimization_Implementation_Sept1_2021/Simulink Function3/floats -> bytes'
 * '<S9>'   : 'Optimization_Implementation_Sept1_2021/While Iterator Subsystem/If Action Subsystem'
 * '<S10>'  : 'Optimization_Implementation_Sept1_2021/While Iterator Subsystem/If Action Subsystem1'
 * '<S11>'  : 'Optimization_Implementation_Sept1_2021/While Iterator Subsystem/If Action Subsystem/bytes -> floats'
 * '<S12>'  : 'Optimization_Implementation_Sept1_2021/While Iterator Subsystem/If Action Subsystem1/bytes -> floats'
 */
#endif                /* RTW_HEADER_Optimization_Implementation_Sept1_2021_h_ */
