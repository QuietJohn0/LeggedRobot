...
PRODUCT_NAME              = Raw_Data_CAN_Subsystem
MAKEFILE                  = Raw_Data_CAN_Subsystem.mk
...
PRODUCT = $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/Raw_Data_CAN_Subsystem
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1/SG_BLO~1/common/libsg -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1/SG_BLO~1/can/include -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
DEFINES_STANDARD = -DMODEL=Raw_Data_CAN_Subsystem -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
%.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


Raw_Data_CAN_Subsystem.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/Raw_Data_CAN_Subsystem.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
can_datatype_ground.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/can_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


Raw_Data_CAN_Subsystem_calintf.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/Raw_Data_CAN_Subsystem_calintf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_code_profiling_utility_functions.o : $(START_DIR)/Raw_Data_CAN_Subsystem_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
