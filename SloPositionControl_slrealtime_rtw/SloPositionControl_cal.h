#ifndef RTW_HEADER_SloPositionControl_cal_h_
#define RTW_HEADER_SloPositionControl_cal_h_
#include "rtwtypes.h"
#include "SloPositionControl_types.h"

/* Storage class 'PageSwitching', for system '<Root>' */
struct SloPositionControl_cal_type {
  real_T Constant_Value;               /* Expression: 2
                                        * Referenced by: '<S1>/Constant'
                                        */
  real_T Constant1_Value[5];           /* Expression: [0,0,0,0,0]
  ...
  real_T Constant_Value_n;             /* Expression: 1
                                        ...
                                        */
  real_T Constant1_Value_b[5];         /* Expression: [0,0,0,0,0]
                                        * Referenced by: '<S4>/Constant1'
                                        */
  real_T Constant_Value_m;             /* Expression: 3
                                        * Referenced by: '<S5>/Constant'
                                        */
  real_T Constant1_Value_f[5];         /* Expression: [0,0,0,0,0]
  ...
  real_T CANSetup_P3;                  /* Expression: termStruct
                                        * Referenced by: '<Root>/CAN Setup '
                                        */
  real_T Constant_Value_d;             /* Expression: 4
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Constant1_Value_a[5];         /* Expression: [0,0,0,0,0]
...
extern SloPositionControl_cal_type *SloPositionControl_cal;

#endif                                /* RTW_HEADER_SloPositionControl_cal_h_ */
