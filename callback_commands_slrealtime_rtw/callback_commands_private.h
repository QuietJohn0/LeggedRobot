...
#ifndef RTW_HEADER_callback_commands_private_h_
#define RTW_HEADER_callback_commands_private_h_
#include "rtwtypes.h"
...
#endif                             /* RTW_HEADER_callback_commands_private_h_ */
