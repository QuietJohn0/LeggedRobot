###########################################################################
## Makefile generated for component 'callback_commands'. 
## 
## Makefile     : callback_commands.mk
## Generated on : Fri Jul 30 16:33:45 2021
## Final product: $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands
...
PRODUCT_NAME              = callback_commands
MAKEFILE                  = callback_commands.mk
...
PRODUCT = $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/callback_commands_slrealtime_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1/SG_BLO~1/common/libsg -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1/SG_BLO~1/can/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
DEFINES_STANDARD = -DMODEL=callback_commands -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/callback_commands_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands.cpp $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands_cal.cpp $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands_data.cpp $(START_DIR)/callback_commands_slrealtime_rtw/can_datatype_ground.cpp $(START_DIR)/callback_commands_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/callback_commands_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/callback_commands_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands_calintf.cpp $(START_DIR)/callback_commands_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_setup_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_status_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_write_s.cpp $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c $(START_DIR)/callback_commands_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o callback_commands.o callback_commands_cal.o callback_commands_data.o can_datatype_ground.o rtGetInf.o rtGetNaN.o rt_nonfinite.o callback_commands_calintf.o main.o sg_IO602_IO691_setup_s.o sg_IO602_IO691_status_s.o sg_IO602_IO691_write_s.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/callback_commands_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/callback_commands_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/callback_commands_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


callback_commands.o : $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


callback_commands_cal.o : $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


callback_commands_data.o : $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


can_datatype_ground.o : $(START_DIR)/callback_commands_slrealtime_rtw/can_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/callback_commands_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/callback_commands_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/callback_commands_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


callback_commands_calintf.o : $(START_DIR)/callback_commands_slrealtime_rtw/callback_commands_calintf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/callback_commands_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_code_profiling_utility_functions.o : $(START_DIR)/callback_commands_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
