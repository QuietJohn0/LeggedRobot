...
getTorque_cal_type getTorque_cal_impl = {
  ...
  /* Computed Parameter: Outport1_Y0_e
   * Referenced by: '<S9>/Outport1'
   */
  0.0,

  /* Computed Parameter: Outport2_Y0_l
   * Referenced by: '<S9>/Outport2'
   */
  0.0,

  /* Computed Parameter: Outport3_Y0_n
   * Referenced by: '<S9>/Outport3'
   */
  0.0,

  /* Computed Parameter: CANRead_P1_Size_o
  ...
  /* Computed Parameter: Outport4_Y0_d
...
getTorque_cal_type *getTorque_cal = &getTorque_cal_impl;
