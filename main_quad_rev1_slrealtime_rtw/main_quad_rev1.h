...
#ifndef RTW_HEADER_main_quad_rev1_h_
#define RTW_HEADER_main_quad_rev1_h_
#include <stddef.h>
#include <cstring>
#include <cmath>
#include <cstring>
...
#include "main_quad_rev1_types.h"
...
struct B_floatsbytes_main_quad_rev1_T {
  uint8_T b[8];                        /* '<S3>/floats -> bytes' */
};

/* Block signals (default storage) */
struct B_main_quad_rev1_T {
  ...
  B_floatsbytes_main_quad_rev1_T sf_floatsbytes_o;/* '<S4>/floats -> bytes' */
  B_floatsbytes_main_quad_rev1_T sf_floatsbytes;/* '<S3>/floats -> bytes' */
};

/* Block states (default storage) for system '<Root>' */
struct DW_main_quad_rev1_T {
  ...
  uint32_T is_c8_main_quad_rev1;       /* '<Root>/Chart' */
  ...
  uint8_T is_active_c8_main_quad_rev1; /* '<Root>/Chart' */
};

/* Real-time Model Data Structure */
struct tag_RTM_main_quad_rev1_T {
...
extern "C" {
  ...
  extern struct B_main_quad_rev1_T main_quad_rev1_B;
...
extern struct DW_main_quad_rev1_T main_quad_rev1_DW;
...
extern "C" {
  ...
  extern void main_quad_rev1_initialize(void);
  extern void main_quad_rev1_step(void);
  extern void main_quad_rev1_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_main_quad_rev1_T *const main_quad_rev1_M;
 ...
 *
 * '<Root>' : 'main_quad_rev1'
 * '<S1>'   : 'main_quad_rev1/Chart'
 * '<S2>'   : 'main_quad_rev1/MATLAB Function1'
 * '<S3>'   : 'main_quad_rev1/Simulink Function1'
 * '<S4>'   : 'main_quad_rev1/Simulink Function3'
 * '<S5>'   : 'main_quad_rev1/While Iterator Subsystem'
 * '<S6>'   : 'main_quad_rev1/Simulink Function1/floats -> bytes'
 * '<S7>'   : 'main_quad_rev1/Simulink Function3/floats -> bytes'
 * '<S8>'   : 'main_quad_rev1/While Iterator Subsystem/If Action Subsystem'
 * '<S9>'   : 'main_quad_rev1/While Iterator Subsystem/If Action Subsystem1'
 * '<S10>'  : 'main_quad_rev1/While Iterator Subsystem/If Action Subsystem/bytes -> floats'
 * '<S11>'  : 'main_quad_rev1/While Iterator Subsystem/If Action Subsystem1/bytes -> floats'
 */
#endif                                 /* RTW_HEADER_main_quad_rev1_h_ */
