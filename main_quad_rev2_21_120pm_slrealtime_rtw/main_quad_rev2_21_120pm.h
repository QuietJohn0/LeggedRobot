...
#ifndef RTW_HEADER_main_quad_rev2_21_120pm_h_
#define RTW_HEADER_main_quad_rev2_21_120pm_h_
#include <stddef.h>
#include <cstring>
#include <cmath>
#include <cstring>
...
#include "main_quad_rev2_21_120pm_types.h"
...
struct B_floatsbytes_main_quad_rev2__T {
  uint8_T b[8];                        /* '<S3>/floats -> bytes' */
};

/* Block signals (default storage) */
struct B_main_quad_rev2_21_120pm_T {
  ...
  real_T CANUnpack_o1_f;               /* '<S8>/CAN Unpack' */
  real_T CANUnpack_o2_l;               /* '<S8>/CAN Unpack' */
  real_T CANUnpack_o3_k;               /* '<S8>/CAN Unpack' */
  real_T CANUnpack_o4_i;               /* '<S8>/CAN Unpack' */
  ...
  uint8_T CANUnpack_o5_p;              /* '<S8>/CAN Unpack' */
  ...
  B_floatsbytes_main_quad_rev2__T sf_floatsbytes_o;/* '<S4>/floats -> bytes' */
  B_floatsbytes_main_quad_rev2__T sf_floatsbytes;/* '<S3>/floats -> bytes' */
};

/* Block states (default storage) for system '<Root>' */
struct DW_main_quad_rev2_21_120pm_T {
  ...
  uint32_T is_c8_main_quad_rev2_21_120pm;/* '<Root>/Chart' */
  ...
  int_T CANUnpack_ModeSignalID_d;      /* '<S8>/CAN Unpack' */
  int_T CANUnpack_StatusPortID_f;      /* '<S8>/CAN Unpack' */
  ...
  uint8_T is_active_c8_main_quad_rev2_21_;/* '<Root>/Chart' */
};

/* Real-time Model Data Structure */
struct tag_RTM_main_quad_rev2_21_120pm_T {
...
extern "C" {
  ...
  extern struct B_main_quad_rev2_21_120pm_T main_quad_rev2_21_120pm_B;
...
extern struct DW_main_quad_rev2_21_120pm_T main_quad_rev2_21_120pm_DW;
...
extern "C" {
  ...
  extern void main_quad_rev2_21_120pm_initialize(void);
  extern void main_quad_rev2_21_120pm_step(void);
  extern void main_quad_rev2_21_120pm_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_main_quad_rev2_21_120pm_T *const main_quad_rev2_21_120pm_M;
 ...
 *
 * '<Root>' : 'main_quad_rev2_21_120pm'
 * '<S1>'   : 'main_quad_rev2_21_120pm/Chart'
 * '<S2>'   : 'main_quad_rev2_21_120pm/MATLAB Function1'
 * '<S3>'   : 'main_quad_rev2_21_120pm/Simulink Function1'
 * '<S4>'   : 'main_quad_rev2_21_120pm/Simulink Function3'
 * '<S5>'   : 'main_quad_rev2_21_120pm/While Iterator Subsystem'
 * '<S6>'   : 'main_quad_rev2_21_120pm/Simulink Function1/floats -> bytes'
 * '<S7>'   : 'main_quad_rev2_21_120pm/Simulink Function3/floats -> bytes'
 * '<S8>'   : 'main_quad_rev2_21_120pm/While Iterator Subsystem/If Action Subsystem'
 * '<S9>'   : 'main_quad_rev2_21_120pm/While Iterator Subsystem/If Action Subsystem1'
 * '<S10>'  : 'main_quad_rev2_21_120pm/While Iterator Subsystem/If Action Subsystem/bytes -> floats'
 * '<S11>'  : 'main_quad_rev2_21_120pm/While Iterator Subsystem/If Action Subsystem1/bytes -> floats'
 */
#endif                               /* RTW_HEADER_main_quad_rev2_21_120pm_h_ */
