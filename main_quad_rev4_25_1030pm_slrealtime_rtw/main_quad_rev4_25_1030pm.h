...
#ifndef RTW_HEADER_main_quad_rev4_25_1030pm_h_
#define RTW_HEADER_main_quad_rev4_25_1030pm_h_
#include <stddef.h>
#include <cstring>
#include <cmath>
#include <cstring>
...
#include "main_quad_rev4_25_1030pm_types.h"
...
struct B_floatsbytes_main_quad_rev4__T {
  uint8_T b[8];                        /* '<S3>/floats -> bytes' */
};

/* Block signals for system '<S21>/bytes -> floats' */
struct B_bytesfloats_main_quad_rev4__T {
...
struct B_main_quad_rev4_25_1030pm_T {
  ...
  real_T P3;                           /* '<Root>/Delay8' */
  real_T P4;                           /* '<Root>/Delay5' */
  real_T Constant;                     /* '<Root>/Constant' */
  real_T P1;                           /* '<Root>/Delay10' */
  real_T P2;                           /* '<Root>/Delay7' */
  real_T P8;                           /* '<Root>/Delay9' */
  real_T P6;                           /* '<Root>/Delay11' */
  real_T P7;                           /* '<Root>/Delay4' */
  real_T P5;                           /* '<Root>/Delay6' */
  ...
  real_T theta2rb;                     /* '<Root>/Chart' */
  real_T theta2b;                      /* '<Root>/Chart' */
  real_T theta1rb;                     /* '<Root>/Chart' */
  real_T theta1b;                      /* '<Root>/Chart' */
  ...
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_f;/* '<S32>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_cd;/* '<S31>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_b;/* '<S30>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_a;/* '<S29>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_j;/* '<S24>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_l;/* '<S23>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats_c;/* '<S22>/bytes -> floats' */
  B_bytesfloats_main_quad_rev4__T sf_bytesfloats;/* '<S21>/bytes -> floats' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_kd;/* '<S10>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_k;/* '<S9>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_bb;/* '<S8>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_if;/* '<S7>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_i;/* '<S6>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_o;/* '<S5>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes_b;/* '<S4>/floats -> bytes' */
  B_floatsbytes_main_quad_rev4__T sf_floatsbytes;/* '<S3>/floats -> bytes' */
};

/* Block states (default storage) for system '<Root>' */
struct DW_main_quad_rev4_25_1030pm_T {
  ...
  real_T pfb;                          /* '<Root>/Chart' */
  real_T wasReady;                     /* '<Root>/Chart' */
  real_T pfrb;                         /* '<Root>/Chart' */
  real_T po1b;                         /* '<Root>/Chart' */
  real_T po1rb;                        /* '<Root>/Chart' */
  real_T po2b;                         /* '<Root>/Chart' */
  real_T po2rb;                        /* '<Root>/Chart' */
  real_T slope1b;                      /* '<Root>/Chart' */
  real_T slope1rb;                     /* '<Root>/Chart' */
  real_T slope2b;                      /* '<Root>/Chart' */
  real_T slope2rb;                     /* '<Root>/Chart' */
  real_T tob;                          /* '<Root>/Chart' */
  real_T tor;                          /* '<Root>/Chart' */
  real_T torb;                         /* '<Root>/Chart' */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Del_h;   /* synthesized block */

  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Del_g;   /* synthesized block */

  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Del_d;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Del_e;   /* synthesized block */

  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Del_a;   /* synthesized block */

  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Del_c;   /* synthesized block */
  ...
  uint32_T is_c8_main_quad_rev4_25_1030pm;/* '<Root>/Chart' */
  uint32_T is_RightFront;              /* '<Root>/Chart' */
  uint32_T is_LeftFront;               /* '<Root>/Chart' */
  uint32_T is_LeftBack;                /* '<Root>/Chart' */
  uint32_T is_RightBack;               /* '<Root>/Chart' */
  ...
  uint8_T is_active_c8_main_quad_rev4_25_;/* '<Root>/Chart' */
  uint8_T is_active_RightFront;        /* '<Root>/Chart' */
  uint8_T is_active_LeftFront;         /* '<Root>/Chart' */
  uint8_T is_active_LeftBack;          /* '<Root>/Chart' */
  uint8_T is_active_RightBack;         /* '<Root>/Chart' */
};

/* Real-time Model Data Structure */
struct tag_RTM_main_quad_rev4_25_1030pm_T {
...
extern "C" {
  ...
  extern struct B_main_quad_rev4_25_1030pm_T main_quad_rev4_25_1030pm_B;
...
extern struct DW_main_quad_rev4_25_1030pm_T main_quad_rev4_25_1030pm_DW;
...
extern "C" {
  ...
  extern void main_quad_rev4_25_1030pm_initialize(void);
  extern void main_quad_rev4_25_1030pm_step(void);
  extern void main_quad_rev4_25_1030pm_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_main_quad_rev4_25_1030pm_T *const main_quad_rev4_25_1030pm_M;
 ...
 *
 * '<Root>' : 'main_quad_rev4_25_1030pm'
 * '<S1>'   : 'main_quad_rev4_25_1030pm/Chart'
 * '<S2>'   : 'main_quad_rev4_25_1030pm/MATLAB Function1'
 * '<S3>'   : 'main_quad_rev4_25_1030pm/Simulink Function1'
 * '<S4>'   : 'main_quad_rev4_25_1030pm/Simulink Function2'
 * '<S5>'   : 'main_quad_rev4_25_1030pm/Simulink Function3'
 * '<S6>'   : 'main_quad_rev4_25_1030pm/Simulink Function4'
 * '<S7>'   : 'main_quad_rev4_25_1030pm/Simulink Function5'
 * '<S8>'   : 'main_quad_rev4_25_1030pm/Simulink Function6'
 * '<S9>'   : 'main_quad_rev4_25_1030pm/Simulink Function7'
 * '<S10>'  : 'main_quad_rev4_25_1030pm/Simulink Function8'
 * '<S11>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1'
 * '<S12>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2'
 * '<S13>'  : 'main_quad_rev4_25_1030pm/Simulink Function1/floats -> bytes'
 * '<S14>'  : 'main_quad_rev4_25_1030pm/Simulink Function2/floats -> bytes'
 * '<S15>'  : 'main_quad_rev4_25_1030pm/Simulink Function3/floats -> bytes'
 * '<S16>'  : 'main_quad_rev4_25_1030pm/Simulink Function4/floats -> bytes'
 * '<S17>'  : 'main_quad_rev4_25_1030pm/Simulink Function5/floats -> bytes'
 * '<S18>'  : 'main_quad_rev4_25_1030pm/Simulink Function6/floats -> bytes'
 * '<S19>'  : 'main_quad_rev4_25_1030pm/Simulink Function7/floats -> bytes'
 * '<S20>'  : 'main_quad_rev4_25_1030pm/Simulink Function8/floats -> bytes'
 * '<S21>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem1'
 * '<S22>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem3'
 * '<S23>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem5'
 * '<S24>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem7'
 * '<S25>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem1/bytes -> floats'
 * '<S26>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem3/bytes -> floats'
 * '<S27>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem5/bytes -> floats'
 * '<S28>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem1/If Action Subsystem7/bytes -> floats'
 * '<S29>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem'
 * '<S30>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem2'
 * '<S31>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem4'
 * '<S32>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem6'
 * '<S33>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem/bytes -> floats'
 * '<S34>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem2/bytes -> floats'
 * '<S35>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem4/bytes -> floats'
 * '<S36>'  : 'main_quad_rev4_25_1030pm/While Iterator Subsystem2/If Action Subsystem6/bytes -> floats'
 */
#endif                              /* RTW_HEADER_main_quad_rev4_25_1030pm_h_ */
