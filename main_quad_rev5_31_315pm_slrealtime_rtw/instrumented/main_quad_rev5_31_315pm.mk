###########################################################################
## Makefile generated for component 'main_quad_rev5_31_315pm'. 
## 
## Makefile     : main_quad_rev5_31_315pm.mk
## Generated on : Tue May 31 17:41:31 2022
## Final product: $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm
...
PRODUCT_NAME              = main_quad_rev5_31_315pm
MAKEFILE                  = main_quad_rev5_31_315pm.mk
...
PRODUCT = $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1/SG_BLO~1/common/libsg -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021a/921~1.1/SG_BLO~1/can/include -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
DEFINES_STANDARD = -DMODEL=main_quad_rev5_31_315pm -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/can_datatype_ground.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm_cal.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm_calintf.cpp $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_read_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_setup_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_status_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021a/9.2.1.1/sg_blocks/can/sg_IO602_IO691_write_s.cpp $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o can_datatype_ground.o main_quad_rev5_31_315pm.o main_quad_rev5_31_315pm_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o main_quad_rev5_31_315pm_calintf.o main.o sg_IO602_IO691_read_s.o sg_IO602_IO691_setup_s.o sg_IO602_IO691_status_s.o sg_IO602_IO691_write_s.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


can_datatype_ground.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/can_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main_quad_rev5_31_315pm.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main_quad_rev5_31_315pm_cal.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main_quad_rev5_31_315pm_calintf.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main_quad_rev5_31_315pm_calintf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_code_profiling_utility_functions.o : $(START_DIR)/main_quad_rev5_31_315pm_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
