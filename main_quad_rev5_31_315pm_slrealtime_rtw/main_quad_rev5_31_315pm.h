...
#ifndef RTW_HEADER_main_quad_rev5_31_315pm_h_
#define RTW_HEADER_main_quad_rev5_31_315pm_h_
#include <stddef.h>
#include <cstring>
#include <cmath>
#include <cstring>
...
#include "main_quad_rev5_31_315pm_types.h"
...
struct B_floatsbytes_main_quad_rev5__T {
  uint8_T b[8];                        /* '<S3>/floats -> bytes' */
};

/* Block signals for system '<S21>/bytes -> floats' */
struct B_bytesfloats_main_quad_rev5__T {
...
struct B_main_quad_rev5_31_315pm_T {
  ...
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_f;/* '<S32>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_cd;/* '<S31>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_b;/* '<S30>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_a;/* '<S29>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_j;/* '<S24>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_l;/* '<S23>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats_c;/* '<S22>/bytes -> floats' */
  B_bytesfloats_main_quad_rev5__T sf_bytesfloats;/* '<S21>/bytes -> floats' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_kd;/* '<S10>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_k;/* '<S9>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_bb;/* '<S8>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_if;/* '<S7>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_i;/* '<S6>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_o;/* '<S5>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes_b;/* '<S4>/floats -> bytes' */
  B_floatsbytes_main_quad_rev5__T sf_floatsbytes;/* '<S3>/floats -> bytes' */
};

/* Block states (default storage) for system '<Root>' */
struct DW_main_quad_rev5_31_315pm_T {
  ...
  real_T Kp1temp;                      /* '<Root>/Chart' */
  real_T Kp2temp;                      /* '<Root>/Chart' */
  real_T p_jump;                       /* '<Root>/Chart' */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_Con_k;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_IfA_f;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_IfA_a;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_If_mb;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_If_pq;   /* synthesized block */

  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_If_ll;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
  } TAQSigLogging_InsertedFor_If_fz;   /* synthesized block */
  ...
  uint32_T is_c8_main_quad_rev5_31_315pm;/* '<Root>/Chart' */
  ...
  uint8_T is_active_c8_main_quad_rev5_31_;/* '<Root>/Chart' */
};

/* Real-time Model Data Structure */
struct tag_RTM_main_quad_rev5_31_315pm_T {
...
extern "C" {
  ...
  extern struct B_main_quad_rev5_31_315pm_T main_quad_rev5_31_315pm_B;
...
extern struct DW_main_quad_rev5_31_315pm_T main_quad_rev5_31_315pm_DW;
...
extern "C" {
  ...
  extern void main_quad_rev5_31_315pm_initialize(void);
  extern void main_quad_rev5_31_315pm_step(void);
  extern void main_quad_rev5_31_315pm_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_main_quad_rev5_31_315pm_T *const main_quad_rev5_31_315pm_M;
 ...
 *
 * '<Root>' : 'main_quad_rev5_31_315pm'
 * '<S1>'   : 'main_quad_rev5_31_315pm/Chart'
 * '<S2>'   : 'main_quad_rev5_31_315pm/MATLAB Function1'
 * '<S3>'   : 'main_quad_rev5_31_315pm/Simulink Function1'
 * '<S4>'   : 'main_quad_rev5_31_315pm/Simulink Function2'
 * '<S5>'   : 'main_quad_rev5_31_315pm/Simulink Function3'
 * '<S6>'   : 'main_quad_rev5_31_315pm/Simulink Function4'
 * '<S7>'   : 'main_quad_rev5_31_315pm/Simulink Function5'
 * '<S8>'   : 'main_quad_rev5_31_315pm/Simulink Function6'
 * '<S9>'   : 'main_quad_rev5_31_315pm/Simulink Function7'
 * '<S10>'  : 'main_quad_rev5_31_315pm/Simulink Function8'
 * '<S11>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1'
 * '<S12>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2'
 * '<S13>'  : 'main_quad_rev5_31_315pm/Simulink Function1/floats -> bytes'
 * '<S14>'  : 'main_quad_rev5_31_315pm/Simulink Function2/floats -> bytes'
 * '<S15>'  : 'main_quad_rev5_31_315pm/Simulink Function3/floats -> bytes'
 * '<S16>'  : 'main_quad_rev5_31_315pm/Simulink Function4/floats -> bytes'
 * '<S17>'  : 'main_quad_rev5_31_315pm/Simulink Function5/floats -> bytes'
 * '<S18>'  : 'main_quad_rev5_31_315pm/Simulink Function6/floats -> bytes'
 * '<S19>'  : 'main_quad_rev5_31_315pm/Simulink Function7/floats -> bytes'
 * '<S20>'  : 'main_quad_rev5_31_315pm/Simulink Function8/floats -> bytes'
 * '<S21>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem1'
 * '<S22>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem3'
 * '<S23>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem5'
 * '<S24>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem7'
 * '<S25>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem1/bytes -> floats'
 * '<S26>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem3/bytes -> floats'
 * '<S27>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem5/bytes -> floats'
 * '<S28>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem1/If Action Subsystem7/bytes -> floats'
 * '<S29>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem'
 * '<S30>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem2'
 * '<S31>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem4'
 * '<S32>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem6'
 * '<S33>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem/bytes -> floats'
 * '<S34>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem2/bytes -> floats'
 * '<S35>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem4/bytes -> floats'
 * '<S36>'  : 'main_quad_rev5_31_315pm/While Iterator Subsystem2/If Action Subsystem6/bytes -> floats'
 */
#endif                               /* RTW_HEADER_main_quad_rev5_31_315pm_h_ */
